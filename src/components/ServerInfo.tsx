...
import { useStore } from '../store'
  ...
  export const ServerInfo = () => {
    ...
    const createChannel = currentUser.role ? (
      <Button bg='transparent' w='30px' h={'30px'} onClick={() => setShowCreateChannel(true)}  marginLeft={'210px'} marginTop='-5px'  position={'fixed'}><Image position={'fixed'} w='10px' src='https://i.ibb.co/YbVFDqN/Plus.png' ></Image></Button>
    ) : null
